...
% Extracting coefficients, p-values, and R-squared value
coefficients = mdl1.Coefficients.Estimate;  % Should be 3 Coefficients for the 'predictors'
pValues = mdl1.Coefficients.pValue;         % Should be 3 P-values for the 'predictors'
rSquared = mdl1.Rsquared.Ordinary;          % R-squared value
